...
public class Gathering {
    ...
    public static void deletePerson() throws InterruptedException {
        System.out.println("Funktion in Bearbeitung");
        Thread.sleep(650);
        System.err.println("Drücken Sie Enter, um zurück zum Startmenü zu gelangen.");
        userInput.nextLine();
        startMenu();
    ...
    public static void allDetails() throws InterruptedException {
        int count = 1;
        for (Person reg : registeredPerson) {
            if (reg != null) {
