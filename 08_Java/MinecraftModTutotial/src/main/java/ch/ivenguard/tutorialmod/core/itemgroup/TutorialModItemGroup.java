package ch.ivenguard.tutorialmod.core.itemgroup;
...
public class TutorialModItemGroup extends ItemGroup {
    ...
    public static final TutorialModItemGroup TUTORIAL_MOD = new TutorialModItemGroup(ItemGroup.GROUPS.length, "tutorial_mod");
